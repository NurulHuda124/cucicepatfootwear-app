            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="text" name="name" value="{{ $asset->name }}" class="form-control" id="name"
                            required>
                    </div>
                    <div class="form-group col-sm-5">
                ...
                <div class="row">
                    <div class="form-group col-sm-5">
                        ...
                        <input type="date" name="buy_date" value="{{ $asset->buy_date }}" class="form-control"
                            id="buy_date">
                    </div>
                    <div class="form-group col-sm-5">
                        <label for="price">Harga pembelian</label>
                        <input type="number" name="price" value="{{ $asset->price }}" class="form-control" id="price"
                            required>
                    </div>
                </div>
                <div class="form-group col-sm-5">
                    <label for="desc">Keterangan</label>
                    <textarea name="desc" class="form-control" id="desc" cols="30" rows="4"
                        placeholder="Masukkan keterangan mengenai aset" required>{{ $asset->desc }}</textarea>
                </div>
            </div>
