...
<head>
    ...
    <link rel="icon" type="image/png" sizes="90x90" href="/img/logo.png">
    <!-- Fonts -->
...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                     ...
                     <ul class="navbar-nav mr-auto">@can('admin')
                                <a class="nav-link" href="{{ route('places.index') }}" ><h5><strong>Data Tempat</strong></h5></a>
                                @endcan</ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"><button class="btn btn-outline-dark"  type="submit">
        ...
        <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="https://web.facebook.com/goblinoutdoor/" class="nav-link p-0 text-muted">
                <i class='bx bxl-facebook-circle bx-xs'></i> Facebook</a></li>
                            <li class="nav-item mb-2"><a href="https://www.instagram.com/goblinoutdoor/" class="nav-link p-0 text-muted">
