                    ...
                    <tbody>
                        @forelse ($assets as $asset)
                            <tr>
                                ...
                                <th class="font-weight-normal">{{ $asset->name }} <br><small
                                        class="text-success">{{ $asset->asset_code }}</small></th>
                                <th class="font-weight-normal">
                                    <p class="btn btn-sm {{ $asset->status == 'used' ? 'btn-primary' : 'btn-danger' }}">
                                        {{ $asset->status }}</p>
                                </th>
                                ...
                                <th>
                                    ...
                                    <a href="/dashboard/assets/{{ $asset->id }}" class="btn btn-success mx-2"><i
